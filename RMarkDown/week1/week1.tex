...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sep.l }\OtherTok{\textless{}{-}}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Sepal.Length}
\NormalTok{sep.w }\OtherTok{\textless{}{-}}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Sepal.Width}
\NormalTok{pet.l }\OtherTok{\textless{}{-}}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Petal.Length}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{save }\OtherTok{\textless{}{-}} \FunctionTok{getOption}\NormalTok{(}\StringTok{"rgl.useNULL"}\NormalTok{)}
\FunctionTok{options}\NormalTok{(}\AttributeTok{rgl.useNULL =} \ConstantTok{TRUE}\NormalTok{)}
\FunctionTok{scatter3d}\NormalTok{(}\AttributeTok{x =}\NormalTok{ sep.l, }\AttributeTok{y =}\NormalTok{ pet.l, }\AttributeTok{z =}\NormalTok{ sep.w, }\AttributeTok{groups =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Species,}
          \AttributeTok{surface =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{ellipsoid =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Explicitly set the elementId property}
\NormalTok{widget}\SpecialCharTok{$}\NormalTok{elementId }\OtherTok{\textless{}{-}} \StringTok{"my{-}rgl{-}plot"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Create an interactive 3D scatter plot}
\FunctionTok{scatter3d}\NormalTok{(}\AttributeTok{x =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Sepal.Length, }\AttributeTok{y =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Petal.Length, }\AttributeTok{z =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Sepal.Width,}
          \AttributeTok{groups =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Species, }\AttributeTok{surface =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{ellipsoid =} \ConstantTok{TRUE}\NormalTok{)}
...
\includegraphics[width=6.5in]{../../../../../../tmp/Rtmp2ZAqzn/file945464d20099}
